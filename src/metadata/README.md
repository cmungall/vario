 ...
 * [vario.yml](vario.yml)
     * Determines how your purl.obolibrary.org/obo/vario/ redirects will be handled
     ...
     * Paste in the contents of [vario.yml](vario.yml)
 ...
 * [vario.md](vario.md)
     ...
     * Paste in the contents of [vario.md](vario.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
